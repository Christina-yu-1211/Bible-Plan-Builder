    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 pb-20 md:pb-0 h-screen flex flex-col">
      ...
      <main className="flex-1 overflow-hidden w-full max-w-7xl mx-auto md:p-4 grid grid-cols-1 md:grid-cols-12 gap-4 no-print relative">
        ...
        <button
          ...
          className="md:hidden absolute bottom-6 right-6 z-50 bg-brand-600 text-white w-14 h-14 rounded-full shadow-xl flex items-center justify-center text-2xl active:scale-95 transition-transform"
          aria-label="Toggle Preview"
        >
          {showMobilePreview ? <i className="fas fa-sliders-h"></i> : <i className="fas fa-eye"></i>}
        </button>
