...
export const PreviewCanvas: React.FC<PreviewCanvasProps> = ({
  ...
  const pagination = useMemo(() => {
    ...
    const effectiveSubtitleScale = styleSettings.subtitleScale ?? 1.0;
    const subTitleSize = Math.max(12, titleSize * 0.35 * effectiveSubtitleScale);

    const titleLineHeight = 1.2;
    const subTitleGap = 20 * (styleSettings.subtitleGap ?? 1.0);
  ...
  }, [schedule, paperDim, planSettings.paperSize, styleSettings.contentScale, styleSettings.lineHeight, styleSettings.titleScale, styleSettings.subtitleScale, styleSettings.subtitleGap]);
